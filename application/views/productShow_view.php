                                                ...
                                                <ul class="megamenu">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="productShow_view.php">Gallery
                                                                    Right</a>
                                                            </li>
                                                            <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Gallery Right</h1>
                        <ul class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li class="current"><span>Gallery Right</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="page-content-inner pt--80 pt-md--60">
                <div class="container">
                    <div class="row no-gutters mb--70 mb-md--57">
                        <div class="col-lg-7 offset-xl-1 product-main-image order-lg-2">
                                            ...
                                            <div class="row gutter-10">
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/product-02-500x575.jpg"
                                                            alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-sm-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/product-15-500x466.jpg"
                                                            alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-sm-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/product-01-500x466.jpg"
                                                            alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/product-14-500x575.jpg"
                                                            alt="Product">
                                                    </figure>
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-5 order-lg-1 product-main-details mt-md--40">
