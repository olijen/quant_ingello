                            ...
                            <ul class="mainmenu">
                                <li class="mainmenu__item menu-item-has-children position-relative">
                                    ...
                                    <div class="inner-menu">
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="/any_files/home.php">Home One</a>
                                            </li>
                                            <li>
                                                <a href="/any_files/home.php">Home Two</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
...
$url = explode("?", $url);
$viewShop = '/main/index';
$viewProduct = '/main/product_show';
$text = '';
if ($viewShop == $url[0]){
    $text = 'ALL PRODUCTS';
}elseif ($viewProduct == $url[0]){
...
<div class="page">
    ...
    <a class="scroll-to-top" href="" style="opacity: 1;"><i class="fa fa-angle-double-up"></i></a>
</div>
