...
//
// todo: удалить папку .idea из репозитория
// todo: вывести слева проекта ссылки на разделы приложения. Должны быть видны постоянно.
// todo: добавить кнопку "создать продукт" в списке продукта
// todo: добавить кнопку "удалить продукт" в списке продукта
// todo: после изменения продукта перекидывать на его просмотр
// todo: при попытке удалить\просмотреть несуществующий продукт выдавать пользовательскую ошибку
